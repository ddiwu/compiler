...
void translate_main(CodeGen *codegen) {
    ...
    codegen->append_inst("addi.d", {"$t1", "$t0", "0"});
    codegen->append_inst("st.d", {"$t1", "$fp", std::to_string(offset_map["%op1"])});
    ...
    codegen->append_inst("addi.d", {"$t1", "$t0", "4"});
    codegen->append_inst("st.d", {"$t1", "$fp", std::to_string(offset_map["%op2"])});
